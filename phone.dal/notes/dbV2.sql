CREATE TABLE [dbo].[Applicant](
	...
	[LAST_NAME_TX] [varchar](50) NOT NULL,
	[FIRST_NAME_TX] [varchar](50) NOT NULL,
	[MIDDLE_INITIAL_TX] [varchar](1) NOT NULL,
	[SUFFIX_TX] [varchar](10) NOT NULL,
	[SSN_TX] [varchar](9) NOT NULL,
...
ALTER TABLE [dbo].[Phone]  WITH CHECK ADD  CONSTRAINT [FK_Phone_Applicant] FOREIGN KEY([APPLICANT_ID])
REFERENCES [dbo].[Applicant] ([APPLICANT_ID])
ALTER TABLE [dbo].[Phone] CHECK CONSTRAINT [FK_Phone_Applicant]
